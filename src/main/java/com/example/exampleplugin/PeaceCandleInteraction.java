...
public class PeaceCandleInteraction extends SimpleBlockInteraction {
    @Nonnull
    ...
    @Nonnull
    public static final BuilderCodec<PeaceCandleInteraction> CODEC = BuilderCodec.builder(PeaceCandleInteraction.class, PeaceCandleInteraction::new, SimpleBlockInteraction.CODEC)
            .documentation("Interact with a peace candle, turn it on or off")
            .build();

    public static final PeaceCandleInteraction INSTANCE = new PeaceCandleInteraction("Peace_Candle");

    public static final RootInteraction ROOT = new RootInteraction(INSTANCE
            .getId(), new String[] { INSTANCE
            .getId() });

    public PeaceCandleInteraction() {}

    public PeaceCandleInteraction(String id) {
        super(id);
    }
    ...
    protected void interactWithBlock(
        ...
        if (player != null) {
            ...
            if (chunkReference != null) {
                ...
                getLogger().atWarning().log("CANDLE INTERACTION CAUGHT");
                return;
    ...
    public String toString() {
        return "PeaceCandleInteraction{} " + super.toString();
    }
}
